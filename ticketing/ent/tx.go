...
func (tx *Tx) init() {
	tx.Concert = NewConcertClient(tx.config)
	tx.ConcertSession = NewConcertSessionClient(tx.config)
...
// applies a query, for example: Concert.QueryXXX(), the query will be executed
