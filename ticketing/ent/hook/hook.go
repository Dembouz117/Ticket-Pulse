...
// The ConcertFunc type is an adapter to allow the use of ordinary
// function as Concert mutator.
type ConcertFunc func(context.Context, *ent.ConcertMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ConcertFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ConcertMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ConcertMutation", m)
}

// The ConcertSessionFunc type is an adapter to allow the use of ordinary
// function as ConcertSession mutator.
type ConcertSessionFunc func(context.Context, *ent.ConcertSessionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ConcertSessionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ConcertSessionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ConcertSessionMutation", m)
}
